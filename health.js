...
const H_NUTR_DEF=[{key:'protein',label:'Protein',unit:'g',color:'#930500',icon:'🥩',note:'Stabilizes blood sugar + PCOS hormones.'},{key:'water',label:'Water',unit:'fl oz',color:'#4A6FA5',icon:'💧',note:'Based on your weight (162 lb × 0.54).'},{key:'fiber',label:'Fiber',unit:'g',color:'#4A6FA5',icon:'🥦',note:'MiraFiber gives you 8g already.'},{key:'fat',label:'Healthy fats',unit:'g',color:'#5C0300',icon:'🥑',note:'Needed for Vitamin D + hormones.'},{key:'carbs',label:'Net carbs',unit:'g',color:'#5C0300',icon:'🍞',note:'Moderate target for T1D.'}];
const H_CC={'Type 1 Diabetes':'#930500','PCOS':'#5C0300','Hypothyroidism':'#4A6FA5','ADHD':'#4A6FA5','Cardiovascular':'#5C0300','Hormone / Contraceptive':'#930500','General / Other':'#888'};
const H_SYMS=[{n:'Fatigue',i:'😴',c:'#95BBEA'},{n:'Brain fog',i:'🌫️',c:'#930500'},{n:'Headache',i:'🤕',c:'#4A6FA5'},{n:'Nausea',i:'🤢',c:'#C23A32'},{n:'Low blood sugar',i:'📉',c:'#6E9BD1'},{n:'High blood sugar',i:'📈',c:'#5C0300'},{n:'Joint pain',i:'🦴',c:'#2E4C73'},{n:'Low mood',i:'😔',c:'#7A1F1A'},{n:'Anxiety',i:'😰',c:'#95BBEA'},{n:'Hot flashes',i:'🔥',c:'#930500'},{n:'Bloating',i:'😣',c:'#4A6FA5'},{n:'Hair loss',i:'🪮',c:'#C23A32'},{n:'Dry skin',i:'🧴',c:'#6E9BD1'},{n:'Insomnia',i:'🌙',c:'#5C0300'},{n:'Cramps',i:'⚡',c:'#2E4C73'},{n:'Acne',i:'😤',c:'#7A1F1A'},{n:'Dizziness',i:'💫',c:'#95BBEA'},{n:'Heart palpitations',i:'💓',c:'#930500'}];
const H_MED_COLORS=['#95BBEA','#930500','#4A6FA5','#C23A32','#6E9BD1','#5C0300','#2E4C73','#7A1F1A'];
const H_SUPP_COLORS=['#95BBEA','#930500','#4A6FA5','#C23A32','#6E9BD1','#5C0300'];
const H_SUGGESTED=[{name:'Magnesium Glycinate',dose:'400–600mg before bed',why:'PCOS + anxiety + sleep + insulin sensitivity.',cond:'PCOS + General',color:'#5C0300'},{name:'Inositol (Myo + D-Chiro 40:1)',dose:'4g/day',why:'Best-studied PCOS supplement. Improves insulin sensitivity, ovulation, acne.',cond:'PCOS',color:'#930500'},{name:'Omega-3 (EPA + DHA)',dose:'2–4g/day',why:'PCOS inflammation, cardiovascular support, mood.',cond:'PCOS + Cardiovascular',color:'#4A6FA5'},{name:'CoQ10 (Ubiquinol)',dose:'200–400mg/day',why:'Rosuvastatin depletes CoQ10 — essential for statin users.',cond:'Cardiovascular',color:'#5C0300'},{name:'B-Complex (methylated)',dose:'High-potency daily',why:'Metformin depletes B12. Methylated bypasses absorption problems.',cond:'T1D + General',color:'#5C0300'},{name:'Berberine',dose:'500mg 2–3× daily with meals',why:'Studied vs Metformin for insulin sensitivity.',cond:'PCOS + T1D',color:'#4A6FA5'},{name:'NAC',dose:'600–1800mg/day',why:'PCOS + liver support + antioxidant. Improves ovulation.',cond:'PCOS + General',color:'#4A6FA5'},{name:'Zinc',dose:'25–50mg with food',why:'Reduces androgens in PCOS, improves acne and hair loss.',cond:'PCOS + Thyroid',color:'#5C0300'},{name:'Selenium',dose:'200mcg/day',why:'Critical for thyroid T4→T3 conversion.',cond:'Hypothyroidism',color:'#1a4a6b'},{name:'Spearmint tea/extract',dose:'2 cups/day or 400mg extract',why:'Reduces testosterone in PCOS. Helps hirsutism, acne, hair loss.',cond:'PCOS',color:'#4A6FA5'},{name:'Iron (with Vitamin C)',dose:'Test first — get ferritin checked!',why:'PCOS frequently causes iron deficiency. Low ferritin = fatigue.',cond:'PCOS',color:'#930500'}];
...
let hMeds=ls(HK.meds,[{id:1,name:'Levothyroxine',dose:'75mcg',form:'Tablet',fnum:1,funit:'day',type:'recurring',cond:'Hypothyroidism',time:'Morning, 30–60 min before food',notes:'Do NOT take within 4 hrs of calcium, iron, antacids, or MiraFiber.',color:'#95BBEA'},{id:2,name:'Ozempic',dose:'2mg',form:'Injection',fnum:1,funit:'week',type:'recurring',cond:'PCOS',time:'Same day each week',notes:'GLP-1 agonist. Rotate injection sites.',color:'#930500'},{id:3,name:'Gabapentin',dose:'900mg (3×300mg)',form:'Capsule',fnum:1,funit:'day',type:'recurring',cond:'General / Other',time:'Take with food',notes:'Taking all at once is fine. Food reduces dizziness.',color:'#4A6FA5'},{id:4,name:'Rosuvastatin',dose:'20mg',form:'Tablet',fnum:1,funit:'day',type:'recurring',cond:'Cardiovascular',time:'Evening preferred',notes:'Avoid grapefruit. Watch for muscle soreness.',color:'#C23A32'},{id:5,name:'Metformin ER',dose:'500mg',form:'Tablet',fnum:1,funit:'day',type:'recurring',cond:'Type 1 Diabetes',time:'With evening meal',notes:'Extended release — take whole. Depletes B12!',color:'#6E9BD1'},{id:6,name:'Norethindrone',dose:'0.35mg',form:'Tablet',fnum:1,funit:'day',type:'recurring',cond:'Hormone / Contraceptive',time:'SAME TIME every day — 3-hour window!',notes:'Progestin-only mini pill. Must stay within same 3-hour window.',color:'#5C0300'},{id:7,name:'Terconazole',dose:'0.4%',form:'Other',fnum:1,funit:'day',type:'limited',cond:'General / Other',time:'At bedtime',notes:'7-day antifungal. Use ALL 7 days.',endDate:'2026-03-23',color:'#2E4C73'}]);
let hSupps=ls(HK.supps,[{id:1,name:'Vitamin D3',dose:'10,000 IU',form:'Gummy',fnum:1,funit:'day',reason:'Documented deficiency',notes:'Take with a fat-containing meal.',color:'#95BBEA'},{id:2,name:'MiraFiber',dose:'8g fiber',form:'Gummy',fnum:1,funit:'day',reason:'Digestive health, blood sugar stability',notes:'Take away from Levothyroxine.',color:'#930500'}]);
...
const calEvents=ls('wg_fc_events',[]);calEvents.push({id:Date.now(),name:'Dr. '+doc,date:date,time:time||'',cat:'health',color:'#4A6FA5',notes:(loc?loc+' — ':'')+notes,recur:'none'});ss('wg_fc_events',calEvents);
...
function renderPeriodList(){
  ...
  const FC={spotting:'#ffb3c1',light:'#ff6b9d',medium:'#930500',heavy:'#930500',very_heavy:'#930500'};
  periods.forEach((p,i)=>{
