...
let stepsHtml='';g.steps.forEach((s,si)=>{stepsHtml+='<div style="display:flex;gap:6px;padding:4px 0;border-bottom:1px solid rgba(0,0,0,.04);font-size:10px;align-items:flex-start"><span style="font-weight:700;color:#4A6FA5;min-width:20px">'+(si+1)+'.</span><span style="flex:1">'+s+'</span><button class="ci-del" onclick="event.stopPropagation();delStep('+gi+','+si+')">×</button></div>'});
